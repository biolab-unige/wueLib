function eventStruct = wlb_readExternalEventFile(sampling_freq,filename, trialIdx)
...
% Edited 2015-05-13 by Gabriele Arnulfo <gabriele.arnulfo@gmail.com>
		...
		for evTypeIdx = 1:nEventTypes
                ...
                eventStruct(evTypeIdx).samples	= round(eventStruct(evTypeIdx).times/sampling_freq);
